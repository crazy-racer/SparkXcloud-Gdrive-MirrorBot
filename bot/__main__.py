...
def stats(update, context):
    ...
    stats = f'<b>╭───《🌐 𝗕𝗢𝗧 𝗦𝗧𝗔𝗧𝗜𝗦𝗧𝗜𝗖𝗦 🌐》</b>\n│\n'\
            f'<b>├─🔢 𝗖𝗼𝗺𝗺𝗶𝘁 𝗗𝗮𝘁𝗲 ⇢ </b> {last_commit}\n\n'\
            ...
            f'<b>├─📤 𝗨𝗽𝗹𝗼𝗮𝗱 ⇢ </b> {sent}\n'\
            f'<b>├─📥 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 ⇢ :</b> {recv}\n\n'\
            f'<b>├─🖥️ 𝗖𝗣𝗨 ⇢ </b> {cpuUsage}%\n'\
            f'<b>├─📏 𝗥𝗔𝗠 ⇢ </b> {mem_p}%\n'\
            f'<b>├─💿 𝗗𝗜𝗦𝗞 ⇢ </b> {disk}%\n\n'\
            f'<b>├─🛰️ 𝗣𝗵𝘆𝘀𝗶𝗰𝗮𝗹 𝗖𝗼𝗿𝗲𝘀 ⇢ </b> {p_core}\n'\
            f'<b>├─⚙️ 𝗧𝗼𝘁𝗮𝗹 𝗖𝗼𝗿𝗲𝘀 ⇢ </b> {t_core}\n\n'\
...
help = telegraph.create_page(
        title='😄 𝐌𝐢𝐫𝐫𝐨𝐫∆𝐜𝐥𝐨𝐮𝐝-𝐆𝐝𝐫𝐢𝐯𝐞-𝐌𝐢𝐫𝐫𝐨𝐫𝐁𝐨𝐭 𝐇𝐞𝐥𝐩 😄',
